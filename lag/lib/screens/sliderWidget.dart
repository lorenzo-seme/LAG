...
class _SliderWidgetState extends State<SliderWidget> {
  ...
  final Map<int, double> _currentValue = {
      1: 0,
      2: 0,
      3: 0
    };
  ...
  _todayResults() async {
    ...
    setState(() {
      _currentValue[1] = sp.getDouble('q1_d${day}_m${month}') ?? 0;
      _currentValue[2] = sp.getDouble('q2_d${day}_m${month}') ?? 0;
      _currentValue[3] = sp.getDouble('q3_d${day}_m${month}') ?? 0;
    });
  }
