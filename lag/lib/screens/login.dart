      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Form(
            ...
            children: [Image.asset('assets/logo.png',scale: 4), // CAMBIA LOGO
              const SizedBox(height: 30,),
              const Text('Welcome',style: TextStyle(fontWeight: FontWeight.w500, fontSize: 30),),
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                     if (await impact.isImpactUp()) {
                      if (_formKey.currentState!.validate()) { // QUA SI POTREBBE METTERE UNA ROTELLA DI CARICAMENTO NELLA UI (CI METTE UN ATTIMINO PRIMA DI FAR VEDERE LA HOME PAGE)
              ...
              const Align(
                  ...
                  child: Text("By logging in, you agree to LAG's\nTerms & Conditions and Privacy Policy",
